			...
			<table width="90%" border="1" cellpadding="1" cellspacing="1">
				...
				<tr>
					<%
							...
							/*  System.out.println("-IN Faculityfeeedback.jsp ");
							  System.out.println("totalcount-->"+totalCount);
							 System.out.println("avgcount-->"+totalCount);
							 System.out.println("goodcount-->"+totalCount);
							 System.out.println("verygoodcount-->"+totalCount);
							 System.out.println("excellentcount-->"+totalCount);
							 */
